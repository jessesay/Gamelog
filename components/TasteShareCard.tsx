...
export default function TasteShareCard({ ownerName, username, genres, platforms, moods = [], backlogCount, playingCount = 0, completedCount = 0, backlogScore, scoreLabel, recommendation, shareable = true }: { ownerName: string; username: string; genres: string[]; platforms: string[]; moods?: string[]; backlogCount: number; playingCount?: number; completedCount?: number; backlogScore: number; scoreLabel: string; recommendation?: { game: any; percentage: number; reasons: string[] }; shareable?: boolean }) {
